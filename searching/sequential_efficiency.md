Sequential (or linear) search, compares each values of the data set to the target value, until the target value is found or the end of the list is achieved. On average, time complexity is O(n)
